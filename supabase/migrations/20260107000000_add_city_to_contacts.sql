...
-- ============================================
-- This column is used in the contact/lead form for B2C leads

-- Add city column to contacts table
ALTER TABLE "public"."contacts" 
  ADD COLUMN IF NOT EXISTS "city" text;

-- Update contacts_summary view to include city
...
GROUP BY
    ...
    co.flat_villa_number, co.building_street, co.area, co.city, co.google_maps_link, co.phone_has_whatsapp,
