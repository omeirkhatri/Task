-- ============================================
-- Add isClient computed column to contacts_summary view
-- ============================================

-- Drop and recreate contacts_summary view with isClient column
...
GROUP BY
    ...
    co.flat_villa_number, co.building_street, co.area, co.google_maps_link, co.phone_has_whatsapp,
    co.services_interested, co.description, co.background, co.avatar, co.first_seen, co.last_seen, 
